...
void AHackNSlashProtoCharacter::Tick(float DeltaSeconds)
{
...
void AHackNSlashProtoCharacter::CancelCurrentAction()
{
	if(Actions.IsValidIndex(CurrentActionIndex))
	{
		Actions[CurrentActionIndex]->Cancel();
...
UActorAction* AHackNSlashProtoCharacter::GetCurrentAction()
{
	return Actions.IsValidIndex(CurrentActionIndex) ? Actions[CurrentActionIndex] : nullptr;
}
